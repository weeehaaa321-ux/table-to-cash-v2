  ...
  async listSessionsForSnapshot(restaurantId: string, todayStartUTC: Date) {
    return db.tableSession.findMany({
      ...
      include: {
        ...
        orders: {
          select: { id: true, orderNumber: true, total: true, status: true, paymentMethod: true, paidAt: true, discount: true, serviceCharge: true, guestNumber: true, guestName: true },
